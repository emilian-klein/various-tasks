"""
Task:
    Write program which reads 9 rows of Sudoku, each containing 9 digits (check carefully if the data entered is valid).
    Outputs appropriate information if Sudoku is valid or not.
